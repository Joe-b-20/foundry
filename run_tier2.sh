...
run exp1_r2_s2 $PY -u gpu_exp1_novelty.py --radius 2 --W 256 --T 256 --batch 32768 --pop 8192 --gens 100 --neural --neural-steps 800 --seed 2 --out runs/exp1_r2_s2
run exp1_r2_s3 $PY -u gpu_exp1_novelty.py --radius 2 --W 256 --T 256 --batch 32768 --pop 8192 --gens 100 --neural --neural-steps 800 --seed 3 --out runs/exp1_r2_s3
# the hard representational stretch: does richer memory + scale crack full multiplication length-gen?
run exp3_mul   $PY -u gpu_exp3_memory.py --arch both --op mul --steps 40000 --hidden 96 --mem_slots 40 --mem_width 12 --seeds 3 --train-width 1 2 3 4 5 6 --test-widths 4 6 8 10 12 16 20 --eval-n 1024
...
run exp2_n5_s1 $PY -u gpu_exp2_qd.py --n 5 --L 8192 --Tmax 30000 --batch 4096 --gens 300 --grid 26 --seed 1 --out runs/exp2_n5_s1
run exp2_n5_s2 $PY -u gpu_exp2_qd.py --n 5 --L 8192 --Tmax 30000 --batch 4096 --gens 300 --grid 26 --seed 2 --out runs/exp2_n5_s2
say "TIER2 ALL-DONE"
