...
run n6_stage1 $PY -u gpu_pcf_hunt.py --stage1 --family n6 --crange 55 --terms 90 --out runs/pcf_n6
# stage 2a: exact PSLQ verify of ALL NEAR candidates (priority arm)
run n6_stage2_near $PY -u gpu_pcf_hunt.py --stage2 --procs 60 --dps 250 --out runs/pcf_n6
...
run n6_stage2_blind $PY -u gpu_pcf_hunt.py --stage2 --procs 60 --dps 250 --out runs/pcf_n6_blind
