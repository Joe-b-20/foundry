...
run exp1b_census $PY -u src/gpu_exp1b_ca2d.py --mode census --H 48 --W 48 --T 96 --batch 1024 --out runs/exp1b_census
...
run exp3_rev     $PY -u src/gpu_exp3_memory.py --arch both --op rev --steps 12000 --hidden 64 --seeds 3 --train-width 1 2 3 4 5 --test-widths 3 5 8 12 16 20 --eval-n 1024
say "TIER1 ALL-DONE"
