...
run n6big_stage1 $PY -u src/gpu_pcf_hunt.py --stage1 --family n6 --crange 120 --terms 90 --out runs/pcf_n6big
run n6big_stage2 $PY -u src/gpu_pcf_hunt.py --stage2 --procs 60 --dps 250 --out runs/pcf_n6big
mkdir -p runs/pcf_n6big_blind && cp runs/pcf_n6big/stage1_blindsample.npz runs/pcf_n6big_blind/stage1_survivors.npz
run n6big_stage2_blind $PY -u src/gpu_pcf_hunt.py --stage2 --procs 60 --dps 250 --out runs/pcf_n6big_blind
